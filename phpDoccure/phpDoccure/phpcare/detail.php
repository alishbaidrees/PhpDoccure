...
<ol class="breadcrumb">
<li class="breadcrumb-item"><a href="speciality.php">Specialities</a></li>
...
FROM doctors
JOIN departments ON doctors.specs = departments.id where doctors.id='$id'
";
...
<p class="doc-speciality"> <?php echo $row['description'] ?>  </p>
<p class="doc-department"><?php echo $row['departs'] ?> </p>
<div class="rating">
...
<p class="doc-location"><i class="fas fa-map-marker-alt"></i> <?php echo $row['city']." , ".$row['country']?>  - <a href="javascript:void(0);">Get Directions</a></p>
...
<li><i class="fas fa-map-marker-alt"></i>  <?php echo $row['city']." , ".$row['country']?> </li>
...
<a class="btn btn-info btn-outline-dark" id="book" href="appointment.php?IID=<?php echo $id ?>">Book Appointment</a>
</div>
</div>
</div>
</div>
...
<a href="#/" class="name">American Medical University</a>
<div>BDS</div>
...
<div class="experience-content">
<div class="timeline-content">
<a href="#/" class="name">Harvard Medical School</a>
<div>MDS</div>
...
<div class="experience-content">
<div class="timeline-content">
<a href="#/" class="name">Glowing Smiles Family Clinic</a>
...
<div class="experience-content">
<div class="timeline-content">
<a href="#/" class="name">Comfort Care Clinic</a>
...
<div class="experience-content">
<div class="timeline-content">
<a href="#/" class="name">Work As senior professional</a>
...
<p><i class="feather-mail"></i> <a href="https://doccure.dreamguystech.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="cda9a2aeaeb8bfa88da8b5aca0bda1a8e3aea2a0">[email&#160;protected]</a></p>
</div>
</div>
</div>
</div>
